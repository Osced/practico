...
if ($PCO_Accion=="recuperar_contrasena" && $PCO_SubAccion=="establecer_nueva_contrasena")
	{
        ...
        */
        PCO_AbrirVentana($MULTILANG_OlvideClave);
...
if ($PCO_Accion=="recuperar_contrasena" && $PCO_SubAccion=="enviar_correo_con_usuario")
	{
        ...
        */
		PCO_AbrirVentana($MULTILANG_OlvideClave, 'info');
...
if ($PCO_Accion=="informes_usuario")
    {
        PCO_AbrirVentana($MULTILANG_UsrAdmInf,'info');
?>
...
if ($PCO_Accion=="permisos_usuario")
    {
        PCO_AbrirVentana($MULTILANG_UsrAdmPer, 'info');
?>
			<form name="salto" action="<?php echo $ArchivoCORE; ?>" method="POST">
                <input type="hidden" name="usuario" value="<?php echo $usuario; ?>">
                <input type="hidden" name="PCO_Accion" value="informes_usuario">
...
if ($PCO_Accion=="agregar_usuario_autoregistro")
	{
        ...
        */
		echo "<br>";
		PCO_AbrirVentana($MULTILANG_UsrAdicion, 'info');
...
if ($PCO_Accion=="ver_seguimiento_general")
			...
			*/
            ...
            PCO_AbrirVentana($MULTILANG_UsrAudUsrs, 'info');
...
if ($PCO_Accion=="ver_seguimiento_especifico")
			...
			*/
				...
				PCO_AbrirVentana($MULTILANG_UsrAudHisto, 'info');
				if ($inicio_reg=="") $inicio_reg=0;
				if ($fin_reg=="") $fin_reg=50;
...
if ($PCO_Accion=="listar_usuarios")
			...
			*/
				PCO_AbrirVentana($MULTILANG_UsrLista, 'info');
                ?>
