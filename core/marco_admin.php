...
<!-- Presenta DashBoard del admin -->
    <div class="row">
     ...
     <div class="row">
        <?php
            echo PCO_ImprimirPanelSimpleDashboard("col-lg-3 col-md-6","primary","white","fa-table",consultar_tablas()->rowCount(),"$MULTILANG_TablaDatos","$MULTILANG_Detalles","javascript:document.administrar_tablas.submit();");
            echo PCO_ImprimirPanelSimpleDashboard("col-lg-3 col-md-6","secondary","white",  "fa-newspaper-o",ContarRegistros($TablasCore."formulario","id>".$ModoDesarrolladorPractico),"$MULTILANG_Formularios","$MULTILANG_Detalles","javascript:document.administrar_formularios.submit();");
            echo PCO_ImprimirPanelSimpleDashboard("col-lg-3 col-md-6","warning","white","fa-file-text",ContarRegistros($TablasCore."informe","id>".$ModoDesarrolladorPractico),"$MULTILANG_Informes","$MULTILANG_Detalles","javascript:document.administrar_informes.submit();");
            echo PCO_ImprimirPanelSimpleDashboard("col-lg-3 col-md-6","dark","white","fa-external-link-square",ContarRegistros($TablasCore."menu"),"$MULTILANG_OpcionesMenu","$MULTILANG_Detalles","javascript:document.administrar_menu.submit();");
            echo PCO_ImprimirPanelSimpleDashboard("col-lg-3 col-md-6","light","dark","fa-users",ContarRegistros($TablasCore."usuario"),"$MULTILANG_Usuario","$MULTILANG_Detalles","javascript:document.listar_usuarios.submit();");
            echo PCO_ImprimirPanelSimpleDashboard("col-lg-3 col-md-6","info","white","fa-eye",ContarRegistros($TablasCore."auditoria"),"$MULTILANG_UsrAuditoria","$MULTILANG_Detalles","javascript:document.PCO_PanelAuditoriaMovimientos.submit();");
            echo PCO_ImprimirPanelSimpleDashboard("col-lg-3 col-md-6","success","white","fa-thumb-tack",ContarRegistros($TablasCore."kanban"),"$MULTILANG_TablerosKanban","$MULTILANG_Detalles","javascript:document.PCO_ExplorarTablerosKanban.submit();");
            echo PCO_ImprimirPanelSimpleDashboard("col-lg-3 col-md-6","white","dark","fa-bug",ContarRegistros($TablasCore."bugtracker"),"$MULTILANG_TblRegistros","$MULTILANG_BTBugtracking","javascript:document.PCO_BugTrackingForm.submit();");
        ?>
    </div>
